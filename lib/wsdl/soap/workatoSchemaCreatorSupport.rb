...
module WorkatoSchemaCreatorSupport
  ...
  def namespace_mapping
    @namespace_mapping ||= {
      "NsCore_2016_2PlatformWebservicesNetsuiteCom" => "platformCore",
      "NsFaults_2016_2PlatformWebservicesNetsuiteCom" => "platformFaults",
      "NsMessages_2016_2PlatformWebservicesNetsuiteCom" => "platformMessages",
      "NsCommon_2016_2PlatformWebservicesNetsuiteCom" => "platformCommon",
      "NsScheduling_2016_2ActivitiesWebservicesNetsuiteCom" => "activitiesScheduling",
      "NsCommunication_2016_2GeneralWebservicesNetsuiteCom" => "generalCommunication",
      "NsFilecabinet_2016_2DocumentsWebservicesNetsuiteCom" => "documentsFileCabinet",
      "NsRelationships_2016_2ListsWebservicesNetsuiteCom" => "listsRelationships",
      "NsSupport_2016_2ListsWebservicesNetsuiteCom" => "listsSupport",
      "NsAccounting_2016_2ListsWebservicesNetsuiteCom" => "listsAccounting",
      "NsSales_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsSales",
      "NsPurchases_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsPurchases",
      "NsCustomers_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsCustomers",
      "NsFinancial_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsFinancial",
      "NsBank_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsBank",
      "NsInventory_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsInventory",
      "NsGeneral_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsGeneral",
      "NsCustomization_2016_2SetupWebservicesNetsuiteCom" => "setupCustomization",
      "NsEmployees_2016_2ListsWebservicesNetsuiteCom" => "listsEmployees",
      "NsWebsite_2016_2ListsWebservicesNetsuiteCom" => "listsWebsite",
      "NsEmployees_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsEmployees",
      "NsMarketing_2016_2ListsWebservicesNetsuiteCom" => "listsMarketing",
      "NsDemandplanning_2016_2TransactionsWebservicesNetsuiteCom" => "transactionsDemandPlanning",
      "NsSupplychain_2016_2ListsWebservicesNetsuiteCom" => "listsSupplyChain"
    }
  end
